    ...
    <div className="mt-20">
      <Carousel showThumbs={false} className="relative">
        <div className="relative h-[500px]">
            <img src="../../../public/칼로리 계산기.jpg" alt="Kcalcalculator" className="h-full object-cover" />
        ...
        <div className="relative h-[500px]">
            <img src="../../../public/음식.jpg" alt="food" className="h-full object-cover" />
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-30">
        ...
        <div className="relative h-[500px]">
            <img src="../../../public/운동.jpg" alt="exercise" className="h-full object-cover" />
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-30">
        ...
        <div className="relative h-[500px]">
            <img src="../../../public/커뮤니티.jpg" alt="community" className="h-full object-cover" />
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-30">
